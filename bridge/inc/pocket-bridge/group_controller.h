...
pocket_group_t** pocket_group_controller_get_list_group(const pocket_group_controller_t* self, uint32_t group_id, const char *search, int *count);
...
uint32_t pocket_group_controller_get_last_id_group_field(pocket_group_controller_t* self);
